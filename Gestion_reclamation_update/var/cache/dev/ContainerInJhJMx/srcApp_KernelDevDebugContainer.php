...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderab9e3 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer386c7 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties86a97 = [
        
    ];

    public function getConnection()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getConnection', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getMetadataFactory', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getExpressionBuilder', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'beginTransaction', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getCache', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getCache();
    }

    public function transactional($func)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'transactional', array('func' => $func), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'wrapInTransaction', array('func' => $func), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'commit', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->commit();
    }

    public function rollback()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'rollback', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getClassMetadata', array('className' => $className), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'createQuery', array('dql' => $dql), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'createNamedQuery', array('name' => $name), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'createQueryBuilder', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'flush', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'clear', array('entityName' => $entityName), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->clear($entityName);
    }

    public function close()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'close', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->close();
    }

    public function persist($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'persist', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'remove', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'refresh', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'detach', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'merge', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getRepository', array('entityName' => $entityName), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'contains', array('entity' => $entity), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getEventManager', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getConfiguration', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'isOpen', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getUnitOfWork', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getProxyFactory', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'initializeObject', array('obj' => $obj), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'getFilters', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'isFiltersStateClean', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'hasFilters', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return $this->valueHolderab9e3->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer386c7 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderab9e3) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderab9e3 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderab9e3->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__get', ['name' => $name], $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        if (isset(self::$publicProperties86a97[$name])) {
            return $this->valueHolderab9e3->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderab9e3;
    ...
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;
    ...
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__isset', array('name' => $name), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;
    ...
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__unset', array('name' => $name), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;
    ...
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__clone', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        $this->valueHolderab9e3 = clone $this->valueHolderab9e3;
    }

    public function __sleep()
    {
        $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, '__sleep', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;

        return array('valueHolderab9e3');
    }
    ...
    {
        $this->initializer386c7 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer386c7;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer386c7 && ($this->initializer386c7->__invoke($valueHolderab9e3, $this, 'initializeProxy', array(), $this->initializer386c7) || 1) && $this->valueHolderab9e3 = $valueHolderab9e3;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderab9e3;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderab9e3;
    }
